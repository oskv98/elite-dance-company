...
// Egresos de la academia: pago de personal, servicios, alquiler, etc.
//
// GET    /egresos?desde=YYYY-MM-DD&hasta=YYYY-MM-DD  → lista (fechas opcionales)
    ...
    try {
        if (request.method === 'GET') {
            ...
            const data = await supabaseFetch(
                env,
                `egresos?select=*${filtro}&order=fecha.desc`,
